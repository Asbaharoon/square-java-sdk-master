...
public class CreateOrderCustomAttributeDefinitionRequest {
    ...
    public boolean equals(Object obj) {
        ...
        CreateOrderCustomAttributeDefinitionRequest other =
                (CreateOrderCustomAttributeDefinitionRequest) obj;
    ...
    public String toString() {
        return "CreateOrderCustomAttributeDefinitionRequest [" + "customAttributeDefinition="
                + customAttributeDefinition + ", idempotencyKey=" + idempotencyKey + "]";
    }

    /**
     * Builds a new {@link CreateOrderCustomAttributeDefinitionRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CreateOrderCustomAttributeDefinitionRequest.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CreateOrderCustomAttributeDefinitionRequest}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link CreateOrderCustomAttributeDefinitionRequest} object using the set
         * fields.
         * @return {@link CreateOrderCustomAttributeDefinitionRequest}
         */
        public CreateOrderCustomAttributeDefinitionRequest build() {
            return new CreateOrderCustomAttributeDefinitionRequest(customAttributeDefinition,
                    idempotencyKey);
        }
    }
}
