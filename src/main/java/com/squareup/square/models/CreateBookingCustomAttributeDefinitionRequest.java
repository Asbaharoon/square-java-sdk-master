...
public class CreateBookingCustomAttributeDefinitionRequest {
    ...
    public boolean equals(Object obj) {
        ...
        CreateBookingCustomAttributeDefinitionRequest other =
                (CreateBookingCustomAttributeDefinitionRequest) obj;
    ...
    public static class Builder {
        ...
        public CreateBookingCustomAttributeDefinitionRequest build() {
            return new CreateBookingCustomAttributeDefinitionRequest(customAttributeDefinition,
                    idempotencyKey);
        }
    }
}
