...
| `LoyaltyPromotions` | [`List<LoyaltyPromotion>`](../../doc/models/loyalty-promotion.md) | Optional | The retrieved loyalty promotions. | List<LoyaltyPromotion> getLoyaltyPromotions() |
