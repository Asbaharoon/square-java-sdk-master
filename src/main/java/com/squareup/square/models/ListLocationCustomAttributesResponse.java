...
public class ListLocationCustomAttributesResponse {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ListLocationCustomAttributesResponse)) {
            return false;
        }
        ListLocationCustomAttributesResponse other = (ListLocationCustomAttributesResponse) obj;
    ...
    public String toString() {
        return "ListLocationCustomAttributesResponse [" + "customAttributes=" + customAttributes
                + ", cursor=" + cursor + ", errors=" + errors + "]";
    }

    /**
     * Builds a new {@link ListLocationCustomAttributesResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ListLocationCustomAttributesResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ListLocationCustomAttributesResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ListLocationCustomAttributesResponse} object using the set fields.
         * @return {@link ListLocationCustomAttributesResponse}
         */
        public ListLocationCustomAttributesResponse build() {
            ListLocationCustomAttributesResponse model =
                    new ListLocationCustomAttributesResponse(customAttributes, cursor, errors);
