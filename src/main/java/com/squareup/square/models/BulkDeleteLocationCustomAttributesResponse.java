...
public class BulkDeleteLocationCustomAttributesResponse {
    ...
    public BulkDeleteLocationCustomAttributesResponse(
            @JsonProperty("values") Map<String, BulkDeleteLocationCustomAttributesResponseLocationCustomAttributeDeleteResponse> values,
    ...
    public boolean equals(Object obj) {
        ...
        BulkDeleteLocationCustomAttributesResponse other =
                (BulkDeleteLocationCustomAttributesResponse) obj;
    ...
    public String toString() {
        return "BulkDeleteLocationCustomAttributesResponse [" + "values=" + values + ", errors="
                + errors + "]";
    }
