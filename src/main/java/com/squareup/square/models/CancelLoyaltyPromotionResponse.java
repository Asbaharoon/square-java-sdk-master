...
public class CancelLoyaltyPromotionResponse {
    ...
    public String toString() {
        return "CancelLoyaltyPromotionResponse [" + "errors=" + errors + ", loyaltyPromotion="
                + loyaltyPromotion + "]";
    }
    ...
    public static class Builder {
        ...
        public CancelLoyaltyPromotionResponse build() {
            CancelLoyaltyPromotionResponse model =
                    new CancelLoyaltyPromotionResponse(errors, loyaltyPromotion);
