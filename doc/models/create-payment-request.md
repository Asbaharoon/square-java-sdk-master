...
| `CustomerId` | `String` | Optional | The [Customer](../../doc/models/customer.md) ID of the customer associated with the payment.<br><br>This is required if the `source_id` refers to a card on file created using the Cards API. | String getCustomerId() |
