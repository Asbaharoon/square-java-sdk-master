...
public class CreateLocationCustomAttributeDefinitionRequest {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CreateLocationCustomAttributeDefinitionRequest)) {
            return false;
        }
        CreateLocationCustomAttributeDefinitionRequest other =
                (CreateLocationCustomAttributeDefinitionRequest) obj;
    ...
    public String toString() {
        return "CreateLocationCustomAttributeDefinitionRequest [" + "customAttributeDefinition="
                + customAttributeDefinition + ", idempotencyKey=" + idempotencyKey + "]";
    }

    /**
     * Builds a new {@link CreateLocationCustomAttributeDefinitionRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CreateLocationCustomAttributeDefinitionRequest.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CreateLocationCustomAttributeDefinitionRequest}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link CreateLocationCustomAttributeDefinitionRequest} object using the set
         * fields.
         * @return {@link CreateLocationCustomAttributeDefinitionRequest}
         */
        public CreateLocationCustomAttributeDefinitionRequest build() {
            return new CreateLocationCustomAttributeDefinitionRequest(customAttributeDefinition,
                    idempotencyKey);
        }
    }
}
