...
public class UpsertOrderCustomAttributeRequest {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpsertOrderCustomAttributeRequest)) {
            return false;
        }
        UpsertOrderCustomAttributeRequest other = (UpsertOrderCustomAttributeRequest) obj;
    ...
    public String toString() {
        return "UpsertOrderCustomAttributeRequest [" + "customAttribute=" + customAttribute
                + ", idempotencyKey=" + idempotencyKey + "]";
    }

    /**
     * Builds a new {@link UpsertOrderCustomAttributeRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link UpsertOrderCustomAttributeRequest.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link UpsertOrderCustomAttributeRequest}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link UpsertOrderCustomAttributeRequest} object using the set fields.
         * @return {@link UpsertOrderCustomAttributeRequest}
         */
        public UpsertOrderCustomAttributeRequest build() {
            return new UpsertOrderCustomAttributeRequest(customAttribute, idempotencyKey);
        }
    }
}
