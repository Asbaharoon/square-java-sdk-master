...
public class VoidTransactionResponse {
    ...
    public boolean equals(Object obj) {
        ...
        VoidTransactionResponse other = (VoidTransactionResponse) obj;
    ...
    public String toString() {
        return "VoidTransactionResponse [" + "errors=" + errors + "]";
    }
    ...
    public static class Builder {
        ...
        public VoidTransactionResponse build() {
            VoidTransactionResponse model =
                    new VoidTransactionResponse(errors);
