...
public class CreateBookingCustomAttributeDefinitionResponse {
    ...
    public boolean equals(Object obj) {
        ...
        CreateBookingCustomAttributeDefinitionResponse other =
                (CreateBookingCustomAttributeDefinitionResponse) obj;
    ...
    public String toString() {
        return "CreateBookingCustomAttributeDefinitionResponse [" + "customAttributeDefinition="
                + customAttributeDefinition + ", errors=" + errors + "]";
    }

    /**
     * Builds a new {@link CreateBookingCustomAttributeDefinitionResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CreateBookingCustomAttributeDefinitionResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CreateBookingCustomAttributeDefinitionResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link CreateBookingCustomAttributeDefinitionResponse} object using the set
         * fields.
         * @return {@link CreateBookingCustomAttributeDefinitionResponse}
         */
        public CreateBookingCustomAttributeDefinitionResponse build() {
            CreateBookingCustomAttributeDefinitionResponse model =
                    new CreateBookingCustomAttributeDefinitionResponse(customAttributeDefinition,
                            errors);
