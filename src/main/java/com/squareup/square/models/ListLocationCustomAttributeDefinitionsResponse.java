...
public class ListLocationCustomAttributeDefinitionsResponse {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ListLocationCustomAttributeDefinitionsResponse)) {
            return false;
        }
        ListLocationCustomAttributeDefinitionsResponse other =
                (ListLocationCustomAttributeDefinitionsResponse) obj;
    ...
    public String toString() {
        return "ListLocationCustomAttributeDefinitionsResponse [" + "customAttributeDefinitions="
                + customAttributeDefinitions + ", cursor=" + cursor + ", errors=" + errors + "]";
    }

    /**
     * Builds a new {@link ListLocationCustomAttributeDefinitionsResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ListLocationCustomAttributeDefinitionsResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ListLocationCustomAttributeDefinitionsResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ListLocationCustomAttributeDefinitionsResponse} object using the set
         * fields.
         * @return {@link ListLocationCustomAttributeDefinitionsResponse}
         */
        public ListLocationCustomAttributeDefinitionsResponse build() {
            ListLocationCustomAttributeDefinitionsResponse model =
                    new ListLocationCustomAttributeDefinitionsResponse(customAttributeDefinitions,
                            cursor, errors);
