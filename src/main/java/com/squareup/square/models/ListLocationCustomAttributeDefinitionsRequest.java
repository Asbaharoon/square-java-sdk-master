...
public class ListLocationCustomAttributeDefinitionsRequest {
     ...
     */
    protected ListLocationCustomAttributeDefinitionsRequest(String visibilityFilter,
    ...
    public boolean equals(Object obj) {
        ...
        ListLocationCustomAttributeDefinitionsRequest other =
                (ListLocationCustomAttributeDefinitionsRequest) obj;
    ...
    public String toString() {
        return "ListLocationCustomAttributeDefinitionsRequest [" + "visibilityFilter="
                + visibilityFilter + ", limit=" + limit + ", cursor=" + cursor + "]";
    }
    ...
    public static class Builder {
        ...
        public ListLocationCustomAttributeDefinitionsRequest build() {
            return new ListLocationCustomAttributeDefinitionsRequest(visibilityFilter, limit,
                    cursor);
        }
    }
}
