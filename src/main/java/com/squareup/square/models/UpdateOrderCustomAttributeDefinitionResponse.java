...
public class UpdateOrderCustomAttributeDefinitionResponse {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdateOrderCustomAttributeDefinitionResponse)) {
            return false;
        }
        UpdateOrderCustomAttributeDefinitionResponse other =
                (UpdateOrderCustomAttributeDefinitionResponse) obj;
    ...
    public String toString() {
        return "UpdateOrderCustomAttributeDefinitionResponse [" + "customAttributeDefinition="
                + customAttributeDefinition + ", errors=" + errors + "]";
    }

    /**
     * Builds a new {@link UpdateOrderCustomAttributeDefinitionResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link UpdateOrderCustomAttributeDefinitionResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link UpdateOrderCustomAttributeDefinitionResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link UpdateOrderCustomAttributeDefinitionResponse} object using the set
         * fields.
         * @return {@link UpdateOrderCustomAttributeDefinitionResponse}
         */
        public UpdateOrderCustomAttributeDefinitionResponse build() {
            UpdateOrderCustomAttributeDefinitionResponse model =
                    new UpdateOrderCustomAttributeDefinitionResponse(customAttributeDefinition,
                            errors);
