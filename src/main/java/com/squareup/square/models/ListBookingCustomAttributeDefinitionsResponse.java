...
public class ListBookingCustomAttributeDefinitionsResponse {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ListBookingCustomAttributeDefinitionsResponse)) {
            return false;
        }
        ListBookingCustomAttributeDefinitionsResponse other =
                (ListBookingCustomAttributeDefinitionsResponse) obj;
    ...
    public String toString() {
        return "ListBookingCustomAttributeDefinitionsResponse [" + "customAttributeDefinitions="
                + customAttributeDefinitions + ", cursor=" + cursor + ", errors=" + errors + "]";
    }

    /**
     * Builds a new {@link ListBookingCustomAttributeDefinitionsResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ListBookingCustomAttributeDefinitionsResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ListBookingCustomAttributeDefinitionsResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ListBookingCustomAttributeDefinitionsResponse} object using the set
         * fields.
         * @return {@link ListBookingCustomAttributeDefinitionsResponse}
         */
        public ListBookingCustomAttributeDefinitionsResponse build() {
            ListBookingCustomAttributeDefinitionsResponse model =
                    new ListBookingCustomAttributeDefinitionsResponse(customAttributeDefinitions,
                            cursor, errors);
