...
public class ListLocationCustomAttributesRequest {
    ...
    public String toString() {
        return "ListLocationCustomAttributesRequest [" + "visibilityFilter=" + visibilityFilter
                + ", limit=" + limit + ", cursor=" + cursor + ", withDefinitions=" + withDefinitions
                + "]";
    }

    /**
     * Builds a new {@link ListLocationCustomAttributesRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ListLocationCustomAttributesRequest.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ListLocationCustomAttributesRequest}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ListLocationCustomAttributesRequest} object using the set fields.
         * @return {@link ListLocationCustomAttributesRequest}
         */
        public ListLocationCustomAttributesRequest build() {
            return new ListLocationCustomAttributesRequest(visibilityFilter, limit, cursor,
                    withDefinitions);
        }
    }
}
