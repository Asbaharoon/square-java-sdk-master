...
public class ListBookingCustomAttributesResponse {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ListBookingCustomAttributesResponse)) {
            return false;
        }
        ListBookingCustomAttributesResponse other = (ListBookingCustomAttributesResponse) obj;
    ...
    public String toString() {
        return "ListBookingCustomAttributesResponse [" + "customAttributes=" + customAttributes
                + ", cursor=" + cursor + ", errors=" + errors + "]";
    }

    /**
     * Builds a new {@link ListBookingCustomAttributesResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ListBookingCustomAttributesResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ListBookingCustomAttributesResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ListBookingCustomAttributesResponse} object using the set fields.
         * @return {@link ListBookingCustomAttributesResponse}
         */
        public ListBookingCustomAttributesResponse build() {
            ListBookingCustomAttributesResponse model =
                    new ListBookingCustomAttributesResponse(customAttributes, cursor, errors);
