...
public class RetrieveBookingCustomAttributeRequest {
     ...
     */
    protected RetrieveBookingCustomAttributeRequest(OptionalNullable<Boolean> withDefinition,
            Integer version) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof RetrieveBookingCustomAttributeRequest)) {
            return false;
        }
        RetrieveBookingCustomAttributeRequest other = (RetrieveBookingCustomAttributeRequest) obj;
    ...
    public String toString() {
        return "RetrieveBookingCustomAttributeRequest [" + "withDefinition=" + withDefinition
                + ", version=" + version + "]";
    }

    /**
     * Builds a new {@link RetrieveBookingCustomAttributeRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link RetrieveBookingCustomAttributeRequest.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link RetrieveBookingCustomAttributeRequest}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link RetrieveBookingCustomAttributeRequest} object using the set fields.
         * @return {@link RetrieveBookingCustomAttributeRequest}
         */
        public RetrieveBookingCustomAttributeRequest build() {
            return new RetrieveBookingCustomAttributeRequest(withDefinition, version);
        }
    }
}
