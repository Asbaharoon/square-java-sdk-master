...
public class RetrieveOrderCustomAttributeDefinitionResponse {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof RetrieveOrderCustomAttributeDefinitionResponse)) {
            return false;
        }
        RetrieveOrderCustomAttributeDefinitionResponse other =
                (RetrieveOrderCustomAttributeDefinitionResponse) obj;
    ...
    public String toString() {
        return "RetrieveOrderCustomAttributeDefinitionResponse [" + "customAttributeDefinition="
                + customAttributeDefinition + ", errors=" + errors + "]";
    }

    /**
     * Builds a new {@link RetrieveOrderCustomAttributeDefinitionResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link RetrieveOrderCustomAttributeDefinitionResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link RetrieveOrderCustomAttributeDefinitionResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link RetrieveOrderCustomAttributeDefinitionResponse} object using the set
         * fields.
         * @return {@link RetrieveOrderCustomAttributeDefinitionResponse}
         */
        public RetrieveOrderCustomAttributeDefinitionResponse build() {
            RetrieveOrderCustomAttributeDefinitionResponse model =
                    new RetrieveOrderCustomAttributeDefinitionResponse(customAttributeDefinition,
                            errors);
