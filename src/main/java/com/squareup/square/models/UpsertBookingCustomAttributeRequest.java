...
public class UpsertBookingCustomAttributeRequest {
     ...
     */
    protected UpsertBookingCustomAttributeRequest(CustomAttribute customAttribute,
    ...
    public String toString() {
        return "UpsertBookingCustomAttributeRequest [" + "customAttribute=" + customAttribute
