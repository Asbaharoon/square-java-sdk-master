...
public class BulkUpsertOrderCustomAttributesResponse {
    ...
    public boolean equals(Object obj) {
        ...
        BulkUpsertOrderCustomAttributesResponse other =
                (BulkUpsertOrderCustomAttributesResponse) obj;
    ...
    public String toString() {
        return "BulkUpsertOrderCustomAttributesResponse [" + "values=" + values + ", errors="
                + errors + "]";
    }
    ...
    public static class Builder {
        ...
        public BulkUpsertOrderCustomAttributesResponse build() {
            BulkUpsertOrderCustomAttributesResponse model =
                    new BulkUpsertOrderCustomAttributesResponse(values, errors);
