...
| `RelatedObjects` | [`List<CatalogObject>`](../../doc/models/catalog-object.md) | Optional | A list of `CatalogObject`s referenced by the object in the `object` field. | List<CatalogObject> getRelatedObjects() |
