...
public class CreateTeamMemberResponse {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CreateTeamMemberResponse)) {
            return false;
        }
        CreateTeamMemberResponse other = (CreateTeamMemberResponse) obj;
    ...
    public String toString() {
        return "CreateTeamMemberResponse [" + "teamMember=" + teamMember + ", errors=" + errors
                + "]";
    }

    /**
     * Builds a new {@link CreateTeamMemberResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CreateTeamMemberResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CreateTeamMemberResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link CreateTeamMemberResponse} object using the set fields.
         * @return {@link CreateTeamMemberResponse}
         */
        public CreateTeamMemberResponse build() {
            CreateTeamMemberResponse model =
                    new CreateTeamMemberResponse(teamMember, errors);
