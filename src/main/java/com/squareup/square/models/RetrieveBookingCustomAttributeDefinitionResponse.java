...
public class RetrieveBookingCustomAttributeDefinitionResponse {
    ...
    public boolean equals(Object obj) {
        ...
        RetrieveBookingCustomAttributeDefinitionResponse other =
                (RetrieveBookingCustomAttributeDefinitionResponse) obj;
    ...
    public String toString() {
        return "RetrieveBookingCustomAttributeDefinitionResponse [" + "customAttributeDefinition="
                + customAttributeDefinition + ", errors=" + errors + "]";
    }

    /**
     * Builds a new {@link RetrieveBookingCustomAttributeDefinitionResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link RetrieveBookingCustomAttributeDefinitionResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link RetrieveBookingCustomAttributeDefinitionResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link RetrieveBookingCustomAttributeDefinitionResponse} object using the
         * set fields.
         * @return {@link RetrieveBookingCustomAttributeDefinitionResponse}
         */
        public RetrieveBookingCustomAttributeDefinitionResponse build() {
            RetrieveBookingCustomAttributeDefinitionResponse model =
                    new RetrieveBookingCustomAttributeDefinitionResponse(customAttributeDefinition,
                            errors);
