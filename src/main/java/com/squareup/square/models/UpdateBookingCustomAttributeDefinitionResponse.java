...
public class UpdateBookingCustomAttributeDefinitionResponse {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdateBookingCustomAttributeDefinitionResponse)) {
            return false;
        }
        UpdateBookingCustomAttributeDefinitionResponse other =
                (UpdateBookingCustomAttributeDefinitionResponse) obj;
    ...
    public String toString() {
        return "UpdateBookingCustomAttributeDefinitionResponse [" + "customAttributeDefinition="
                + customAttributeDefinition + ", errors=" + errors + "]";
    }

    /**
     * Builds a new {@link UpdateBookingCustomAttributeDefinitionResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link UpdateBookingCustomAttributeDefinitionResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link UpdateBookingCustomAttributeDefinitionResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link UpdateBookingCustomAttributeDefinitionResponse} object using the set
         * fields.
         * @return {@link UpdateBookingCustomAttributeDefinitionResponse}
         */
        public UpdateBookingCustomAttributeDefinitionResponse build() {
            UpdateBookingCustomAttributeDefinitionResponse model =
                    new UpdateBookingCustomAttributeDefinitionResponse(customAttributeDefinition,
                            errors);
