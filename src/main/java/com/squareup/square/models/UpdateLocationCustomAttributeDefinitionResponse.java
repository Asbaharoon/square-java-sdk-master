...
public class UpdateLocationCustomAttributeDefinitionResponse {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdateLocationCustomAttributeDefinitionResponse)) {
            return false;
        }
        UpdateLocationCustomAttributeDefinitionResponse other =
                (UpdateLocationCustomAttributeDefinitionResponse) obj;
    ...
    public String toString() {
        return "UpdateLocationCustomAttributeDefinitionResponse [" + "customAttributeDefinition="
                + customAttributeDefinition + ", errors=" + errors + "]";
    }

    /**
     * Builds a new {@link UpdateLocationCustomAttributeDefinitionResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link UpdateLocationCustomAttributeDefinitionResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link UpdateLocationCustomAttributeDefinitionResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link UpdateLocationCustomAttributeDefinitionResponse} object using the set
         * fields.
         * @return {@link UpdateLocationCustomAttributeDefinitionResponse}
         */
        public UpdateLocationCustomAttributeDefinitionResponse build() {
            UpdateLocationCustomAttributeDefinitionResponse model =
                    new UpdateLocationCustomAttributeDefinitionResponse(customAttributeDefinition,
                            errors);
