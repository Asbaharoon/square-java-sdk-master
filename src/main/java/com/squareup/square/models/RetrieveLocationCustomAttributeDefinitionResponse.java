...
public class RetrieveLocationCustomAttributeDefinitionResponse {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof RetrieveLocationCustomAttributeDefinitionResponse)) {
            return false;
        }
        RetrieveLocationCustomAttributeDefinitionResponse other =
                (RetrieveLocationCustomAttributeDefinitionResponse) obj;
    ...
    public String toString() {
        return "RetrieveLocationCustomAttributeDefinitionResponse [" + "customAttributeDefinition="
                + customAttributeDefinition + ", errors=" + errors + "]";
    }

    /**
     * Builds a new {@link RetrieveLocationCustomAttributeDefinitionResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link RetrieveLocationCustomAttributeDefinitionResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link RetrieveLocationCustomAttributeDefinitionResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link RetrieveLocationCustomAttributeDefinitionResponse} object using the
         * set fields.
         * @return {@link RetrieveLocationCustomAttributeDefinitionResponse}
         */
        public RetrieveLocationCustomAttributeDefinitionResponse build() {
            RetrieveLocationCustomAttributeDefinitionResponse model =
                    new RetrieveLocationCustomAttributeDefinitionResponse(customAttributeDefinition,
                            errors);
