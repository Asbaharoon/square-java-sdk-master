...
/**
 * This is a model class for FulfillmentShipmentDetails type.
 */
public class FulfillmentShipmentDetails {
     ...
     */
    protected FulfillmentShipmentDetails(FulfillmentRecipient recipient,
    ...
    public boolean equals(Object obj) {
        ...
        FulfillmentShipmentDetails other = (FulfillmentShipmentDetails) obj;
    ...
    public String toString() {
        return "FulfillmentShipmentDetails [" + "recipient=" + recipient + ", carrier=" + carrier
                + ", shippingNote=" + shippingNote + ", shippingType=" + shippingType
    ...
    /**
     * Builds a new {@link FulfillmentShipmentDetails.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link FulfillmentShipmentDetails.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link FulfillmentShipmentDetails}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link FulfillmentShipmentDetails} object using the set fields.
         * @return {@link FulfillmentShipmentDetails}
         */
        public FulfillmentShipmentDetails build() {
            return new FulfillmentShipmentDetails(recipient, carrier, shippingNote, shippingType,
                    trackingNumber, trackingUrl, placedAt, inProgressAt, packagedAt,
