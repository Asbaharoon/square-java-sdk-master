...
public class ListBookingCustomAttributeDefinitionsRequest {
     ...
     */
    protected ListBookingCustomAttributeDefinitionsRequest(OptionalNullable<Integer> limit,
    ...
    public boolean equals(Object obj) {
        ...
        ListBookingCustomAttributeDefinitionsRequest other =
                (ListBookingCustomAttributeDefinitionsRequest) obj;
    ...
    public String toString() {
        return "ListBookingCustomAttributeDefinitionsRequest [" + "limit=" + limit + ", cursor="
                + cursor + "]";
    }
