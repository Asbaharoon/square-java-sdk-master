...
public class DeprecatedCreateDisputeEvidenceTextRequest {
    ...
    public boolean equals(Object obj) {
        ...
        DeprecatedCreateDisputeEvidenceTextRequest other =
                (DeprecatedCreateDisputeEvidenceTextRequest) obj;
    ...
    public String toString() {
        return "DeprecatedCreateDisputeEvidenceTextRequest [" + "idempotencyKey=" + idempotencyKey
    ...
    public static class Builder {
        ...
        public DeprecatedCreateDisputeEvidenceTextRequest build() {
            return new DeprecatedCreateDisputeEvidenceTextRequest(idempotencyKey, evidenceText,
                    evidenceType);
        }
    }
}
