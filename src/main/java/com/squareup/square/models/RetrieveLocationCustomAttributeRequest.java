...
public class RetrieveLocationCustomAttributeRequest {
    ...
    public boolean equals(Object obj) {
        ...
        RetrieveLocationCustomAttributeRequest other = (RetrieveLocationCustomAttributeRequest) obj;
    ...
    public String toString() {
        return "RetrieveLocationCustomAttributeRequest [" + "withDefinition=" + withDefinition
                + ", version=" + version + "]";
    }

    /**
     * Builds a new {@link RetrieveLocationCustomAttributeRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link RetrieveLocationCustomAttributeRequest.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link RetrieveLocationCustomAttributeRequest}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link RetrieveLocationCustomAttributeRequest} object using the set fields.
         * @return {@link RetrieveLocationCustomAttributeRequest}
         */
        public RetrieveLocationCustomAttributeRequest build() {
            return new RetrieveLocationCustomAttributeRequest(withDefinition, version);
        }
    }
}
