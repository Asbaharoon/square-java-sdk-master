...
public class CreateOrderCustomAttributeDefinitionResponse {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CreateOrderCustomAttributeDefinitionResponse)) {
            return false;
        }
        CreateOrderCustomAttributeDefinitionResponse other =
                (CreateOrderCustomAttributeDefinitionResponse) obj;
    ...
    public String toString() {
        return "CreateOrderCustomAttributeDefinitionResponse [" + "customAttributeDefinition="
                + customAttributeDefinition + ", errors=" + errors + "]";
    }

    /**
     * Builds a new {@link CreateOrderCustomAttributeDefinitionResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CreateOrderCustomAttributeDefinitionResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CreateOrderCustomAttributeDefinitionResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link CreateOrderCustomAttributeDefinitionResponse} object using the set
         * fields.
         * @return {@link CreateOrderCustomAttributeDefinitionResponse}
         */
        public CreateOrderCustomAttributeDefinitionResponse build() {
            CreateOrderCustomAttributeDefinitionResponse model =
                    new CreateOrderCustomAttributeDefinitionResponse(customAttributeDefinition,
                            errors);
