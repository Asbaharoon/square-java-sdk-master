...
public class UpsertOrderCustomAttributeResponse {
    ...
    public String toString() {
        return "UpsertOrderCustomAttributeResponse [" + "customAttribute=" + customAttribute
                + ", errors=" + errors + "]";
    }
    ...
    public static class Builder {
        ...
        public UpsertOrderCustomAttributeResponse build() {
            UpsertOrderCustomAttributeResponse model =
                    new UpsertOrderCustomAttributeResponse(customAttribute, errors);
