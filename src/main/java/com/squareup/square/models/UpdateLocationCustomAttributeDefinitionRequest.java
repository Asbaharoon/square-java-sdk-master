...
public class UpdateLocationCustomAttributeDefinitionRequest {
    ...
    public boolean equals(Object obj) {
        ...
        UpdateLocationCustomAttributeDefinitionRequest other =
                (UpdateLocationCustomAttributeDefinitionRequest) obj;
    ...
    public static class Builder {
        ...
        public UpdateLocationCustomAttributeDefinitionRequest build() {
            return new UpdateLocationCustomAttributeDefinitionRequest(customAttributeDefinition,
                    idempotencyKey);
        }
    }
}
