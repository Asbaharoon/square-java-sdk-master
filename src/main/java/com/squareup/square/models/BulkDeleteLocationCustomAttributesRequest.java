...
public class BulkDeleteLocationCustomAttributesRequest {
    ...
    public BulkDeleteLocationCustomAttributesRequest(
            @JsonProperty("values") Map<String, BulkDeleteLocationCustomAttributesRequestLocationCustomAttributeDeleteRequest> values) {
        this.values = values;
    }
    ...
    public boolean equals(Object obj) {
        ...
        BulkDeleteLocationCustomAttributesRequest other =
                (BulkDeleteLocationCustomAttributesRequest) obj;
