...
public class CloneOrderResponse {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CloneOrderResponse)) {
            return false;
        }
        CloneOrderResponse other = (CloneOrderResponse) obj;
    ...
    public String toString() {
        return "CloneOrderResponse [" + "order=" + order + ", errors=" + errors + "]";
    }

    /**
     * Builds a new {@link CloneOrderResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CloneOrderResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CloneOrderResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link CloneOrderResponse} object using the set fields.
         * @return {@link CloneOrderResponse}
         */
        public CloneOrderResponse build() {
            CloneOrderResponse model =
                    new CloneOrderResponse(order, errors);
