...
|  --- | --- | --- | --- | --- |
| `PayoutEntries` | [`List<PayoutEntry>`](../../doc/models/payout-entry.md) | Optional | The requested list of payout entries, ordered with the given or default sort order. | List<PayoutEntry> getPayoutEntries() |
