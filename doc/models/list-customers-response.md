...
| `Customers` | [`List<Customer>`](../../doc/models/customer.md) | Optional | The customer profiles associated with the Square account or an empty object (`{}`) if none are found. | List<Customer> getCustomers() |
