...
public class BulkDeleteBookingCustomAttributesResponse {
    ...
    public boolean equals(Object obj) {
        ...
        BulkDeleteBookingCustomAttributesResponse other =
                (BulkDeleteBookingCustomAttributesResponse) obj;
    ...
    public String toString() {
        return "BulkDeleteBookingCustomAttributesResponse [" + "values=" + values + ", errors="
                + errors + "]";
    }
