...
public class TestWebhookSubscriptionResponse {
    ...
    public String toString() {
        return "TestWebhookSubscriptionResponse [" + "errors=" + errors
    ...
    public Builder toBuilder() {
        Builder builder = new Builder()
                .errors(getErrors())
                .subscriptionTestResult(getSubscriptionTestResult());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public TestWebhookSubscriptionResponse build() {
            TestWebhookSubscriptionResponse model =
                    new TestWebhookSubscriptionResponse(errors, subscriptionTestResult);
