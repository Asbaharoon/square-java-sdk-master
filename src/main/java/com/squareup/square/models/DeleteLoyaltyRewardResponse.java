...
public class DeleteLoyaltyRewardResponse {
    ...
    public boolean equals(Object obj) {
        ...
        DeleteLoyaltyRewardResponse other = (DeleteLoyaltyRewardResponse) obj;
    ...
    public String toString() {
        return "DeleteLoyaltyRewardResponse [" + "errors=" + errors + "]";
    }
    ...
    public static class Builder {
        ...
        public DeleteLoyaltyRewardResponse build() {
            DeleteLoyaltyRewardResponse model =
                    new DeleteLoyaltyRewardResponse(errors);
