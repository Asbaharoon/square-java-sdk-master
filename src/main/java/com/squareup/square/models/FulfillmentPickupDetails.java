...
public class FulfillmentPickupDetails {
    ...
    public FulfillmentPickupDetails(
            ...
            @JsonProperty("curbside_pickup_details") FulfillmentPickupDetailsCurbsidePickupDetails curbsidePickupDetails) {
    ...
    public static class Builder {
        ...
        public FulfillmentPickupDetails build() {
            return new FulfillmentPickupDetails(recipient, expiresAt, autoCompleteDuration,
