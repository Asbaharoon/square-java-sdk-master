...
public class UpdateBookingCustomAttributeDefinitionRequest {
    ...
    public boolean equals(Object obj) {
        ...
        UpdateBookingCustomAttributeDefinitionRequest other =
                (UpdateBookingCustomAttributeDefinitionRequest) obj;
    ...
    public String toString() {
        return "UpdateBookingCustomAttributeDefinitionRequest [" + "customAttributeDefinition="
                + customAttributeDefinition + ", idempotencyKey=" + idempotencyKey + "]";
    }

    /**
     * Builds a new {@link UpdateBookingCustomAttributeDefinitionRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link UpdateBookingCustomAttributeDefinitionRequest.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link UpdateBookingCustomAttributeDefinitionRequest}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link UpdateBookingCustomAttributeDefinitionRequest} object using the set
         * fields.
         * @return {@link UpdateBookingCustomAttributeDefinitionRequest}
         */
        public UpdateBookingCustomAttributeDefinitionRequest build() {
            return new UpdateBookingCustomAttributeDefinitionRequest(customAttributeDefinition,
                    idempotencyKey);
        }
    }
}
