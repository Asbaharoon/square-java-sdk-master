...
public class UpsertLocationCustomAttributeResponse {
    ...
    public String toString() {
        return "UpsertLocationCustomAttributeResponse [" + "customAttribute=" + customAttribute
                + ", errors=" + errors + "]";
    }

    /**
     * Builds a new {@link UpsertLocationCustomAttributeResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link UpsertLocationCustomAttributeResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link UpsertLocationCustomAttributeResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link UpsertLocationCustomAttributeResponse} object using the set fields.
         * @return {@link UpsertLocationCustomAttributeResponse}
         */
        public UpsertLocationCustomAttributeResponse build() {
            UpsertLocationCustomAttributeResponse model =
                    new UpsertLocationCustomAttributeResponse(customAttribute, errors);
