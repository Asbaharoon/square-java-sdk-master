...
public class UpdateOrderCustomAttributeDefinitionRequest {
     ...
     */
    protected UpdateOrderCustomAttributeDefinitionRequest(
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdateOrderCustomAttributeDefinitionRequest)) {
            return false;
        }
        UpdateOrderCustomAttributeDefinitionRequest other =
                (UpdateOrderCustomAttributeDefinitionRequest) obj;
    ...
    public String toString() {
        return "UpdateOrderCustomAttributeDefinitionRequest [" + "customAttributeDefinition="
                + customAttributeDefinition + ", idempotencyKey=" + idempotencyKey + "]";
    }

    /**
     * Builds a new {@link UpdateOrderCustomAttributeDefinitionRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link UpdateOrderCustomAttributeDefinitionRequest.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link UpdateOrderCustomAttributeDefinitionRequest}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link UpdateOrderCustomAttributeDefinitionRequest} object using the set
         * fields.
         * @return {@link UpdateOrderCustomAttributeDefinitionRequest}
         */
        public UpdateOrderCustomAttributeDefinitionRequest build() {
            return new UpdateOrderCustomAttributeDefinitionRequest(customAttributeDefinition,
                    idempotencyKey);
        }
    }
}
